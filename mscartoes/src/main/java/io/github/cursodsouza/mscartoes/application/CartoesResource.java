...
import io.github.cursodsouza.mscartoes.application.representation.CartaoSaveResquest;
...
public class CartoesResource {
    ...
    @PostMapping
    public ResponseEntity cadastra(@RequestBody CartaoSaveResquest request) {
